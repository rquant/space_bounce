 ...
 * The mouse handler is responsible for handling all mouse interactions
   ...
   TODO: Maybe the mouse handler should be decoupled from the actual actions
         For the game. The stage mouse event handlers in this module could get
         points of the users click and then publish them in a topic subscribed
         to in a game state submodule...
 */
