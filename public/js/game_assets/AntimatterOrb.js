...
(function (window) {
    ...
    p.initialize = function() {
        ...
        this.parentContainer = orbFieldContainer;
        this.radius = 5;
        ...
        this.bodyType = b2Body.b2_kinematicBody;
        box2d.createCircularPhysicsBody(this);
    }
    ...
    window.AntimatterOrb = AntimatterOrb;
