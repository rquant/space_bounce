...
(function (window) {
    ...
    function ForceField(x, y, width, height, angle, tracingMode) {
        this.initialize(x, y, width, height, angle, tracingMode);
    }
    ...
    p.initialize = function(x, y,width, height, angle, tracingMode) {
        
        this.Shape_initialize();
        
        this.parentContainer = forceFieldContainer;
        this.width = width;
        this.height = height;
        this.regX = width/2;
        this.regY = height/2;
    ...
    p.terminate = function() {
        createjs.Tween.get(this, {loop:false}).to({alpha:1}, 100, createjs.Ease.quadIn)
        .to({alpha:0.4}, 100, createjs.Ease.quadIn).call(function () {
            forceFieldContainer.removeChild(this);
        });
    }
